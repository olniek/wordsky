...
`Landing -> Topic -> Study -> (optional) Map -> back to Study`
...
- The Map shows the **same language subset** as Study: your anchor plus the translation languages you chose on Landing (not every language in the topic)
...
4. Landing progress and CTA text (`Start/Continue/Review`)
